...
static int init_project_info(void)
{
    ...
    push_component_info(CPU, cpu_type, "Qualcomm");
        ...
        push_component_info(NFC, "ST21NFCD", "ST");
    #else
        push_component_info(WCN, "WCN6851", "QualComm");
        push_component_info(NFC, "SN100", "NXP");
    #endif
    #ifdef CONFIG_ARCH_HOLI
    push_component_info(TP, "nt36672c", "NOVATEK");
    #endif
    ...
    #ifdef CONFIG_ARCH_HOLI
    push_component_info(R_CAMERA, "ov13b10", "OmniVision");
    push_component_info(SECOND_R_CAMERA, "ov02b10", "OmniVision");
    push_component_info(F_CAMERA, "imx471", "Sony");
    push_component_info(THIRD_R_CAMERA, "gc02m1b", "Galaxyc");
    push_component_info(FAST_CHARGE, "pm7250b", "QualComm");
    #endif
