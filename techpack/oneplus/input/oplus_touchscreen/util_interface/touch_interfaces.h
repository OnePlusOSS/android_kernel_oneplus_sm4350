...
int touch_i2c_read(struct i2c_client *client, char *writebuf, unsigned short writelen, char *readbuf, unsigned short readlen);
int touch_i2c_write(struct i2c_client *client, char *writebuf, unsigned short writelen);
