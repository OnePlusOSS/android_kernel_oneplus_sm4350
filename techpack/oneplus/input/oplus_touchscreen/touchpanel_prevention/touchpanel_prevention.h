...
struct fw_grip_operations {
    int                     (*set_fw_grip_area) (void *chip_data, struct grip_zone_area *grip_zone, bool enable);   /*set the fw grip area*/
    void                    (*set_touch_direction) (void *chip_data, uint8_t dir);                                  /*set touch direction in fw*/
    int                     (*set_no_handle_area) (void *chip_data, struct kernel_grip_info *grip_info);            /*set no handle area in fw*/
    int                     (*set_condition_frame_limit) (void *chip_data, int frame);                              /*set condition frame limit in fw*/
    int                     (*set_large_frame_limit) (void *chip_data, int frame);                                  /*set large frame limit in fw*/
    int                     (*set_large_corner_frame_limit) (void *chip_data, int frame);                           /*set large condition frame limit in fw*/
