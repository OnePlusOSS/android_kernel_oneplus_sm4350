...
int qg_get_battery_temp(struct qpnp_qg *chip, int *temp)
{
	...
	pr_debug("ntc_calibration: voltage_pre = %d, ichg = %d, therm_pre = %d\n",
			voltage_pre, g_oplus_qg_ibta, therm_pre);
	...
	*temp = therm_now;
	pr_debug("ntc_calibration: voltage = %d, ichg = %d, therm = %d\n",
			voltage_now, g_oplus_qg_ibta, therm_now);
