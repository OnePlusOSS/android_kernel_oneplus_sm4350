...
EXPORT_SYMBOL(oplus_gauge_get_batt_mvolts);
...
EXPORT_SYMBOL(oplus_gauge_get_batt_mvolts_2cell_max);
...
EXPORT_SYMBOL(oplus_gauge_get_batt_mvolts_2cell_min);
int oplus_gauge_get_batt_temperature(void)
{
	int batt_temp = 0;
	if (!g_gauge_chip) {
		printk(KERN_ERR "[OPLUS_CHG] oplus_gauge_get_batt_temperature g_gauge_chip NULL! \n");
		return 250;
	} else {
		if (gauge_dbg_tbat != 0) {
...
EXPORT_SYMBOL(oplus_gauge_get_remaining_capacity);
...
EXPORT_SYMBOL(oplus_gauge_get_batt_fcc);
...
EXPORT_SYMBOL(oplus_gauge_get_batt_hmac);
...
EXPORT_SYMBOL(oplus_gauge_get_batt_authenticate);
...
EXPORT_SYMBOL(oplus_gauge_check_chip_is_null);
...
EXPORT_SYMBOL(oplus_gauge_get_prev_batt_mvolts);
...
EXPORT_SYMBOL(oplus_gauge_get_prev_batt_mvolts_2cell_max);
...
EXPORT_SYMBOL(oplus_gauge_get_prev_batt_mvolts_2cell_min);
int oplus_gauge_get_prev_batt_temperature(void)
{
	int batt_temp = 0;
	if (!g_gauge_chip){
		printk(KERN_ERR "[OPLUS_CHG]oplus_gauge_get_prev_batt_temperature g_gauge_chip NULL!\n");
		return 250;
		}
	else {
		if (gauge_dbg_tbat != 0) {
...
EXPORT_SYMBOL(oplus_gauge_get_prev_batt_temperature);
...
EXPORT_SYMBOL(oplus_gauge_get_prev_batt_soc);
...
EXPORT_SYMBOL(oplus_gauge_get_prev_remaining_capacity);
...
EXPORT_SYMBOL(oplus_gauge_get_prev_batt_fcc);
