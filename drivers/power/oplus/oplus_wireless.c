...
EXPORT_SYMBOL(oplus_wireless_charge_start);
...
EXPORT_SYMBOL(oplus_wpc_get_fast_charging);
...
EXPORT_SYMBOL(oplus_wpc_get_ffc_charging);
...
EXPORT_SYMBOL(oplus_wpc_get_fw_updating);
...
EXPORT_SYMBOL(oplus_wpc_get_adapter_type);
...
EXPORT_SYMBOL(oplus_wpc_print_log);
